...
public class DistanceEuclidienneTest {
    ...
    void testDistancePokemon() {
        ...
        assertEquals(new DistanceEuclidienne().distance(t1, t2), 650011.47, 0.01);
    }
    ...
    void testDistanceIris() {
        ...
        assertEquals(new DistanceEuclidienne().distance(i1, i2), 5.38, 0.01);
    }
    ...
    void testDistanceTitanic() {
        ...
        assertEquals(new DistanceEuclidienne().distance(t1, t2), 349.57, 0.01 );
    }
